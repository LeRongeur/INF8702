...
void CFBO::Init( int w, int h )
{
   ...
   GLfloat vec[4] = { 1.0, 1.0, 1.0, 1.0 };
   glTexParameterfv(GL_TEXTURE_2D, GL_TEXTURE_BORDER_COLOR, vec);
   ...
   glFramebufferTexture2D(GL_DRAW_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_TEXTURE_2D, m_Profondeur, 0);
